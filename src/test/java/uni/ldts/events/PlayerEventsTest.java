...
public class PlayerEventsTest {
    ...
    @Test
    public void movePlayer() throws InvocationTargetException, IllegalAccessException {
    ...
    @Test
    public void playerDied() throws InvocationTargetException, IllegalAccessException {
    ...
    @Test
    public void invalidMove() throws InvocationTargetException, IllegalAccessException {
        manager.getWorld().getCharacter().getPos().x = -5;
        manager.getEventManager().callEvent(new PlayerMoveEvent(manager.getWorld().getCharacter(), new Vector2D(16,84)));
        assertEquals(manager.getWorld().getCharacter().getPos().x, 16);
        assertEquals(manager.getWorld().getCharacter().getPos().y, 84);
    }
}
